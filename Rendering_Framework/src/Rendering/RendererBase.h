...
namespace INANOA {
	namespace OPENGL {
		...
		public:
			bool init(const std::string& vsResource, const std::string& fsResource, const std::string& resetcsResource, const std::string& cullingcsResource, const int width, const int height);
            ...
            GLuint getProgramID(const char* program);
